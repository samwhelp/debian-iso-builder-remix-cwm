...
| `+` | `+` |
| [debian-iso-builder-remix-cwm](https://samwhelp.github.io/debian-iso-builder-remix-cwm/) | [GitHub](https://github.com/samwhelp/debian-iso-builder-remix-cwm) |
| `=` | `=` |
| [debian-iso-builder-respin-cwm](https://samwhelp.github.io/debian-iso-builder-respin-cwm/) | [GitHub](https://github.com/samwhelp/debian-iso-builder-respin-cwm) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-remix-cwm/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-remix-cwm/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-remix-cwm/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-remix-cwm](https://github.com/samwhelp/debian-iso-builder-remix-cwm)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-remix-cwm.git
```


> change dir to `debian-iso-builder-remix-cwm`

``` sh
cd debian-iso-builder-remix-cwm
```
...
> change dir to `~/work/debian-iso-builder-remix-cwm/iso-profile`

``` sh
cd ~/work/debian-iso-builder-remix-cwm/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/debian-iso-builder-remix-cwm/iso-profile/dist`
